                                        ...
                                        <tr>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li><a style="color:green" href="controller/ijin?nik=<?= $d_karyawan['nik'];?>&ijin=sakit&date=<?= $skr; ?>&area=<?= $d_karyawan['area'];?>" onclick="return confirm('Apakah Jemaat No. Anggota <?= $d_karyawan['nik'];?> tidak masuk karena sakit?')"> Sakit</a></li>
													<li><a style="color:blue" href="controller/ijin?nik=<?= $d_karyawan['nik'];?>&ijin=ijin&date=<?= $skr; ?>&area=<?= $d_karyawan['area'];?>" onclick="return confirm('Apakah Jemaat No. Anggota <?= $d_karyawan['nik'];?> ijin tidak masuk?')">Ijin</a></li>
													<li><a style="color:black" href="controller/ijin?nik=<?= $d_karyawan['nik'];?>&ijin=cuti&date=<?= $skr; ?>&area=<?= $d_karyawan['area'];?>" onclick="return confirm('Apakah Jemaat No. Anggota <?= $d_karyawan['nik'];?> ijin cuti?')">Cuti</a></li>
													<li><a style="color:red" href="controller/ijin?nik=<?= $d_karyawan['nik'];?>&ijin=alpa&date=<?= $skr; ?>&area=<?= $d_karyawan['area'];?>" onclick="return confirm('Apakah Jemaat No. Anggota <?= $d_karyawan['nik'];?> tidak masuk tanpa keterangan/ALPA?')">Alpa</a></li>
												</ul>
											</div>
											<?php 
