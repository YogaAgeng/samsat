...
if ($cek==0){
$s_p ="INSERT into karyawan (nik,nama, job_title,no_telp, jenis_kelamin, agama, lokasi, area, sub_area, start_date, end_date,foto) VALUES('$nik','$nama','$job_title','$no_telp', '$jenis_kelamin','$agama','$lokasi', '$area','$sub_area','$start_date','$end_date', '$photo')";
