...
if(empty($photo)){
$s_p ="UPDATE karyawan set nama ='$nama', job_title ='$job_title', no_telp ='$no_telp', jenis_kelamin ='$jenis_kelamin', agama='$agama', lokasi='$lokasi', area='$area', sub_area='$sub_area', start_date='$start_date', end_date='$end_date' WHERE nik='$nik'";
} elseif (!empty($photo)) {
...
//identitas file asli
	$s_p ="UPDATE karyawan set nama ='$nama', job_title ='$job_title', no_telp ='$no_telp', jenis_kelamin ='$jenis_kelamin', agama='$agama', lokasi='$lokasi', area='$area', sub_area='$sub_area', start_date='$start_date', end_date='$end_date', foto='$new_foto' WHERE nik='$nik'";
